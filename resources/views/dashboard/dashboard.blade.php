...
@section('body-classes')auth @endsection
...
@section('content')
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="icons-font-awesome.html"><i class="icon-star"></i> Font
                                    Awesome <span class="badge badge-secondary">4.7</span></a>
                            </li>
                            <li class="nav-item">
    ...
    <footer class="app-footer">
        ...
        <span class="float-right text-secondary small">Powered by <a class="text-secondary" href="http://coreui.io" rel="nofollow noopener noreferer">CoreUI</a>
        </span>
    </footer>
